...
_io_rev0 = [
    ...
    ("sdcard", 0,
        ...
        Subsignal("data", Pins("D13 E13 E15 E13"), Misc("PULLMODE=UP")),
    ...
    ("eth", 0,
        ...
        Subsignal("rx_ctl",  Pins("B15")),
        Subsignal("rx_data", Pins("A12 A13 C14 A14")),
        Subsignal("tx_ctl",  Pins("A18")),
        Subsignal("tx_data", Pins("B17 A17 B16 A16")),
        IOStandard("LVCMOS33")
    ),
]
